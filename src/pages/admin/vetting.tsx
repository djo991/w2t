...
import { Check, X, ExternalLink, MapPin, Mail, ArrowLeft } from "lucide-react";
    ...
    <AdminRoute>
      <div className="min-h-screen bg-background pb-20">
        ...
        <div className="container mx-auto px-4 py-8 max-w-5xl">
            <div className="mb-6">
            <Link href="/admin" className="inline-flex items-center text-sm text-muted-foreground hover:text-[hsl(var(--ink-red))] transition-colors">
